...
EntityPlayer = ig.Entity.extend({
	...
	draw: function() {
		...
		if (ig.input.state('wall')) {
			this.font.draw("Metal: " + this.wallCost.metal + " Wood: " + this.wallCost.wood, 40, 25, ig.Font.ALIGN.LEFT );
		}
		if (ig.input.state('tower1')) {
			this.font.draw("Metal: " + this.towerCost.metal + " Wood: " + this.towerCost.wood, 40, 25, ig.Font.ALIGN.LEFT );
		}
		if (ig.input.state('bomb')) {
			this.font.draw("Metal: " + this.bombCost.metal + " Wood: " + this.bombCost.wood, 40, 25, ig.Font.ALIGN.LEFT);
		}
		if (ig.input.state('nuke')) {
			this.font.draw("Metal: " + this.nukeCost.metal + " Wood: " + this.nukeCost.wood, 40, 25, ig.Font.ALIGN.LEFT );
		}
